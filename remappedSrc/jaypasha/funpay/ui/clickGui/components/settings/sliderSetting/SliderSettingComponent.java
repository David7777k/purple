...
public class SliderSettingComponent extends SettingComponent {
    ...
    Supplier<String> descriptionText = Suppliers.memoize(() ->
            Objects.isNull(getSettingLayer().getDescription())
                    ? "Описание отсутствует."
                    : MsdfUtil.cutString(getSettingLayer().getDescription().getString(), 6, 240f / 2 - 10));
