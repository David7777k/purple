package jaypasha.funpay.api.commands.list.friend;
...
public class FriendLayerCommand extends CommandLayer {

    public FriendLayerCommand() {
        super(Lists.newArrayList("friend", "f"));

        getArguments().add(new AddArgumentLayer(0, FriendsRepository::getFriend));
        getArguments().add(new RemoveArgumentLayer(0, FriendsRepository::getFriend));
    }
