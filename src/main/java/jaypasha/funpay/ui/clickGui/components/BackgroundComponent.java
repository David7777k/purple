...
public class BackgroundComponent extends Component {
    ...
    public BackgroundComponent render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Api.blur()
                ...
                .radius(new QuadRadiusState(15f / 2))
                .blurRadius(24f)
                .build()
        ...
        Api.shadow()
                ...
                .build()
                .render(context.getMatrices().peek().getPositionMatrix(), getX() - .5f, getY() - .5f);
        ...
        Api.rectangle()
                ...
                .radius(new QuadRadiusState(2, 15f / 2, 15f / 2, 2))
                .build()
                .render(context.getMatrices().peek().getPositionMatrix(), getX(), getY() + getHeight() - 15);

        List<String> modulesList = Pasxalka.getInstance().getModuleRepository().getModuleLayers().stream()
        ...
        if (!modulesList.isEmpty()) {
            String string = join(modulesList, ", ");
            ...
            Api.text()
                    ...
                    .font(Api.inter())
                    .build()
                    .render(context.getMatrices().peek().getPositionMatrix(), getX() + 5, getY() + getHeight() - 15 + Api.inter().getHeight(string, 7) / 2);
            Scissors.pop();
        }
